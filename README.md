...
Установщик запросит отдельный логин и пароль администратора панели. Ограничения длины нет, допускается даже пустой пароль, хотя это существенно снижает защиту панели. Пароль хранится только как `scrypt`-хеш. Использовать SSH-пароль Raspberry не требуется.
